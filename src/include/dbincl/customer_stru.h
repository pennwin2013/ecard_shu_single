...
int DB_t_customer_read_by_stuempno_and_status(const char *v_stuempno,const char *v_status,T_t_customer *pt_customer);
int DB_t_customer_read_by_stuempno_and_areacode(const char *v_stuempno,const char *v_areacode,T_t_customer *pt_customer);
#endif
