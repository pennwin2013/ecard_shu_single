...
int DB_t_netacc_read_by_accno(const char *v_accno,T_t_netacc *pt_netacc);
int DB_t_netacc_update_by_accno(char *v_accno,T_t_netacc *pt_netacc);
int DB_t_netacc_del_by_accno(const char *v_accno);
int DB_t_netacc_read_lock_by_c0_and_accno(const char *v_accno,T_t_netacc *pt_netacc);
