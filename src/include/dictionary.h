...
#define SYSPARA_ECARDCLIENT_VERNO	9		//前台版本号
...
#define DEVUSAGE_BANKTRANS 			2023	//设备用途-银行转账
...
#define USERTYPE_CARDNO				11		//一卡通-卡号
#define USERTYPE_SNO				12		//一卡通-学号
#define USERTYPE_CUSTID				13		//一卡通-客户号
#define USERTYPE_MOBILE				21		//手机号
#define USERTYPE_EMAIL				22		//email
...
#define CLOSEAPPLYSTATUS_NEW		1 //新申请
#define CLOSEAPPLYSTATUS_CHECKED	2 //已审核
#define CLOSEAPPLYSTATUS_PROCESS	3 //处理中
#define CLOSEAPPLYSTATUS_ERROR		4 //错误
#define CLOSEAPPLYSTATUS_FINISHED	5 //完成
...
#define POSDATATYPE_COLLSEND			4   //
#define POSDATATYPE_IMPORT				5   //补采脱机流水
#define POSDATATYPE_ADDLOST				6   //补记流水
...
#define STATUS_RENEW				'4'		//已补办待转移余额
#define STATUS_INSTEAD			'5'		//待换卡
#define STATUS_CLOSING			'6'		//待销户
#define STATUS_ISSUEFAIL			'9'		//发卡失败
...
#define DTLSTATUS_NOACC			'9'				//不记账流水
...
#define STATUS_TRUE 1 // 真
#define STATUS_FALSE 0 // 假
