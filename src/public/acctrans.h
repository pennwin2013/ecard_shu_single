...
#define TRANSTYPE_SHOPSUBSIDY           213 //商户下发补助到代领补助

#define TRANSTYPE_EPAYTRANS             220//易支付代充值
#define TRANSTYPE_BATCLOSERETCARDBAL    221 //批量销户退卡余额
#define TRANSTYPE_BATCLOSERETSUBSIDY    222 //批量销户退补助
#define TRANSTYPE_WATER2DEPOSIT         230 //水控转水控存款 
#define TRANSTYPE_CARDDRAW              231 //持卡人取款
#define TRANSTYPE_POSPAYMENT            232 //POS消费
#define TRANSTYPE_CARDPAYMENT           233 //支付交易
#define TRANSTYPE_CLOSERETCASH          234 //消费退现金
...
#define TRANSTYPE_OPERPAYMENT           295  //操作员解款
//利润
...
#define TRANSTYPE_CARD2INCOME_LOST      701 //丢失流水发生额转营业外收入
#define TRANSTYPE_CARD2INCOME_WFAILED   702 //中途拔卡流水发生额转营业外收入
#define TRANSTYPE_CARD2INCOME_OTHER     709 //其他流水发生额转营业外收入
...
public:
    ...
    int doHistoryReverseTrans(const char *accdate, int termid, int termseqno);
public:
    // 辅助函数
